//Farm : NxM Grid
//Each cell in the grid is a square plot
//Each Plot is planted with a variety of crop
//Farmer has 26 Varieties [a,z] (a to z both included)
//Conditions:
//  1. At least 2 different Varities of crops in each row
//  2. Any number of crops in a column
//  3. No 2 nearby plots can have same variety of crops
//Given:
//  - Current state of farm
//To-Do:
//  - Find minimum number of plots to replant with a DIFFERENT CROP for 
//    the above condition to be satisfied
//Input:
//  - Line 1: 2 Integers, N and M
//  - Next N lines: M lowercase letters from 'a' to 'z' (Representing Crop Variety)
//Output:
//  - Single Integer: Minimum Number of plots to be replanted (To Satisfy the Conditions Imposed)
...
public class GridProblem {
    public static void main(String[] args) {
        ...
        for (int i=0;i<N;i++){
            ...
            System.out.println("\nInput "+M+" (not space separated) Crops in row (Letters 'a'to 'z') "+(i+1)+" : ");
